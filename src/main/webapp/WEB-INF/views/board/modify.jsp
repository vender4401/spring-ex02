...
<div class="container-sm">
	...
	<form id="modify-form" method="post" action="${root }/board/modify">
			...
			<div class="form-group">
	 		...
	 		<input name="bno" class="form-control" id="input3" readonly value="${board.bno }">
	 		</div>

			<div class="form-group">
		    <label for="input1">제목</label>
		    <input value='<c:out value="${board.title }" />' name="title" type="text" class="form-control" id="input1" placeholder="제목을 입력 하세요.">
		  	</div>		  	
