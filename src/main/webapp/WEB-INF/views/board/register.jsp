...
<div class="container-sm">
	...
	<form method="post">
		    ...
		    <input name="title" type="text" class="form-control" id="input1" placeholder="제목을 입력 하세요.">
		  	</div>		  	
		    ...
		    <input name="writer" type="text" class="form-control" id="input1" placeholder="이름을 입력하세요">
		  	</div>
